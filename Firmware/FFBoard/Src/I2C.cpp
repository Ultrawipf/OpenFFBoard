...
bool I2CPort::transmitMaster(const uint16_t addr,uint8_t* pData,const uint16_t size,const uint32_t timeout){
...
bool I2CPort::writeMem(const uint16_t devAddr,const uint16_t memAddr,const uint16_t memAddSize,uint8_t* pData,const uint16_t size,const uint32_t timeout){
