...
uint16_t VirtAddVarTab[NB_OF_VAR] =
	{
		...
		ADR_FFBJOYSTICK_BUTTONCONF,ADR_FFBJOYSTICK_ANALOGCONF,
		...
		ADR_FFBAXIS1_CONFIG, ADR_FFBAXIS1_POWER, ADR_FFBAXIS1_DEGREES, ADR_FFBAXIS1_ENDSTOP,
		...
		ADR_FFBAXIS1_EFFECTS1, ADR_FFBAXIS1_EFFECTS2,

		ADR_FFBAXIS2_CONFIG,ADR_FFBAXIS2_POWER,ADR_FFBAXIS2_DEGREES,ADR_FFBAXIS2_ENDSTOP,
		...
		ADR_FFBAXIS2_EFFECTS1,ADR_FFBAXIS2_EFFECTS2,

		ADR_FFBAXIS3_CONFIG,ADR_FFBAXIS3_POWER,ADR_FFBAXIS3_DEGREES,ADR_FFBAXIS3_ENDSTOP,
		...
		ADR_FFBAXIS3_EFFECTS1,ADR_FFBAXIS3_EFFECTS2
	};
