...
//			   0x55,0x00,         //    Unit Exponent 0
//			0xC0     ,            //    End Collection
//			HIDDESC_FFB_SETCONDREP,

			// Condition report depends on ffb axis count
			// 125 bytes following
...
__ALIGN_BEGIN const uint8_t hid_2ffb_desc_32b[USB_HID_2FFB_REPORT_DESC_32B_SIZE] __ALIGN_END =
{
		0x05, 0x01,                    /* USAGE_PAGE (Generic Desktop)*/
			0x09, 0x04,                    /* USAGE (Joystick)*/
			0xa1, 0x01,                    /* COLLECTION (Application)*/
