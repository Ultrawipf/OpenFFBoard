...
#define CDC_DATA_FS_MAX_PACKET_SIZE                 64  /* Endpoint IN & OUT Packet size */ // For lower endpoints 64 is fine
//#endif
...
}__attribute__((packed)) USBD_CDC_ItfTypeDef;
...
}__attribute__((packed)) USBD_CDC_HandleTypeDef;
