...
#include "constants.h"
//#include "usbd_custom_hid_if.h" //buf size
...
#define CUSTOM_HID_EPIN_SIZE                 64 //0x11 needed for Gamepad reports
...
#define USBD_CUSTOMHID_OUTREPORT_BUF_SIZE     512

 /*---------- -----------*/

#define USBD_CUSTOM_HID_REPORT_DESC_SIZE     1267//1290//68//
